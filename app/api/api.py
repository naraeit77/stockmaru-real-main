...
from app.api.routes.stock_management import router as stock_management_router
...
api_router.include_router(stock_management_router, prefix="/api/management", tags=["종목 관리"])